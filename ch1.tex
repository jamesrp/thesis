...
We are interested in the probability that the percolation occurs.
...
\draw[dotted] (0,.5) -- (1,.5);
  \draw[thick] (0,0) -- (0.1,0.0333) -- (0.11,0.0539) -- (0.12,0.0841) -- (0.13,0.1298) -- (0.14,0.1776) -- (0.15,0.2369) -- (0.16,0.2949) -- (0.17,0.3546) -- (0.18,0.4124) -- (0.19,0.4674) -- (0.2,0.5277) -- (0.22,0.6441) -- (0.24,0.7197) -- (0.26,0.7911) -- (0.28,0.8466) -- (0.3,0.8852) -- (0.333,0.9259) -- (0.366,0.9575) -- (0.4,0.9762) -- (0.5,0.997) -- (0.6,0.9995) -- (0.7,1.0) -- (0.8,1.0) -- (0.9,1.0) -- (1,1);
\end{tikzpicture}
\hfill
\begin{tikzpicture}[scale=3]
\node at (.145,-.1) {0.14};
...
\draw[dotted] (0,.5) -- (1,.5);
  \draw[thick] (0,0) -- (0.1,0.1105) -- (0.11,0.1849) -- (0.12,0.2734) -- (0.13,0.3628) -- (0.14,0.4638) -- (0.15,0.5466) -- (0.16,0.6424) -- (0.17,0.7048) -- (0.18,0.7521) -- (0.19,0.8045) -- (0.2,0.8329) -- (0.23,0.9148) -- (0.26,0.9532) -- (0.3,0.9819) -- (0.4,0.9982) -- (0.5,0.9999) -- (0.7,1.0) -- (1,1);
\end{tikzpicture}
\caption{Plots of $\mathbb{P}(\textup{percolation})$ vs $p$ for nearest neighbor $[n]^2$, for $n = 5, 10, 15$. Critical probabilities are indicated.}
\label{htperc}
\end{figure}
