...
TODO - put example of stable set first theta body here.
Also define: 
...
In fact, for $i=2$, the stable set case, we have a similar phenomenon: $\textup{STAB}(G) \subseteq \textup{TH}_1(G) \subseteq \textup{QSTAB}(G)$. 
